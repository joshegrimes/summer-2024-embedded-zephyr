...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SYS_CLOCK_HW_CYCLES_PER_SEC, 144000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_TI_OPT3001_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_ROSPI_ENV, 1);

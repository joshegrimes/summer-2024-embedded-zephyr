...
struct _isr_table_entry __sw_isr_table _sw_isr_table[82] = {
	...
	{(const void *)0x80045a8, (ISR)0x8000e69}, /* 6 */
	{(const void *)0x80045a4, (ISR)0x8000e69}, /* 7 */
	{(const void *)0x80045a0, (ISR)0x8000e69}, /* 8 */
	{(const void *)0x800459c, (ISR)0x8000e69}, /* 9 */
	{(const void *)0x8004598, (ISR)0x8000e69}, /* 10 */
	...
	{(const void *)0x8004594, (ISR)0x8000e69}, /* 23 */
	...
	{(const void *)0x8004590, (ISR)0x8000e69}, /* 40 */
